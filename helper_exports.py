...
def create_powerpoint(gpt_summary, float_fig, milestone_fig, title="Delay Impact Analysis"):
    ...
    # Save Float Chart
    float_img_path = "/mnt/data/float_chart.png"
    float_fig.savefig(float_img_path, bbox_inches='tight')

    # Save Milestone Chart
    milestone_img_path = "/mnt/data/milestone_chart.png"
    ...
    pptx_path = "/mnt/data/Delay_Impact_Analysis_PPTX.pptx"
    prs.save(pptx_path)
    return pptx_path
...
def create_word_doc(gpt_summary, float_fig, milestone_fig, title="Delay Impact Report"):
    ...
    word_path = "/mnt/data/Delay_Impact_Report_Word.docx"
    doc.save(word_path)
    return word_path
